<?php
	...
	$paginate_data = getPagData($conn,'services');
/*
  prepared statement:
...
*/
	$sql = "SELECT id, svc_name FROM services order by id LIMIT ? OFFSET ?";
...
STR;
        ...
        $str_script = <<<STR
<script type='text/javascript'>
    $('#info_sect').html("<span class='error_color'>No services. Query error.</span>");
</script>
STR;
        /* return */
        echo $str_script;
