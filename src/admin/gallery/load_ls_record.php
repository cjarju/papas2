...
*/
		$sql = "SELECT id, img_name, img_descr FROM gphotos WHERE id = ?";
...
<table class='table table-hover table-condensed table_autofit'>
	...
	<thead>
		<tr> <th>ID</th> <th>Image</th> <th>Description</th> <th>Edit</th> <th>Delete</th> </tr>
	</thead>
	<tbody>
		<tr>
			<td> $id </td>
			<td> <img src='$file_path' alt='' > </td>
			<td> $img_descr </td>
...
STR;
                ...
                /* could not get record or stmt error */
            ...
            /* return */
			echo 'Could not retrieve record. Query error.';
		}
	}
    else {
        /* $_POST['id'] is empty */
